...
define simple_rule
$(TARGET_DIR)/$(1)/runtime_%.txt: fit_$(1).py fetch_data.py sackmann.py
	@echo "Fitting $(1) $$*"
...
define numpyro_rule
$(TARGET_DIR)/pymc_numpyro_$(1)_$(2)/runtime_%.txt: fit_pymc_numpyro.py fetch_data.py sackmann.py
...
$(TARGET_DIR)/pymc_blackjax_$(1)_$(2)/runtime_%.txt: fit_pymc_blackjax.py fetch_data.py sackmann.py
